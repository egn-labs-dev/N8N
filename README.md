...
3. В ноді **"Save to Google Sheets"** — заміни `YOUR_GOOGLE_SHEET_ID` на твій Spreadsheet ID
...
├── prompts/
│   └── sdr-real-estate.txt  # 📝 SDR промпт (для довідки)
├── .env.example           # 🔑 Шаблон API ключів
